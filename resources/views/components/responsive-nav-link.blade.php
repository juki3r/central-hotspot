...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-white text-left text-base font-medium text-dark bg-white focus:outline-none focus:text-dark focus:bg-white focus:border-white transition duration-150 ease-in-out'
